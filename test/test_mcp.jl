...
@testset "MCP Client" begin
    ...
    @testset "_normalize_tool_name" begin
        @test AgentFramework._normalize_tool_name("read-file") == "read_file"
        @test AgentFramework._normalize_tool_name("my.tool.name") == "my_tool_name"
        @test AgentFramework._normalize_tool_name("tool/action") == "tool_action"
        @test AgentFramework._normalize_tool_name("already_valid_123") == "already_valid_123"
        @test AgentFramework._normalize_tool_name("special@chars!here") == "special_chars_here"
    end
    ...
    @testset "mcp_tools_to_function_tools" begin
        ...
        @test length(fts) == 3
        @test fts[1].name == "tool_a"
        @test fts[2].name == "tool_b"
        @test fts[3].name == "tool_c"
    end
